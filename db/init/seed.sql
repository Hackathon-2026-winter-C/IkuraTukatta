...
ADD COLUMN icon_key VARCHAR(50) NOT NULL DEFAULT 'default'
AFTER name;
...
(id, user_id, group_id, name, icon_key, color, is_io_type, created_at, updated_at)
VALUES
  -- 支出（0）
  (1,  1, 1, '食費',      'food',      '#FFB44F', 0, NOW(), NOW()),
  (2,  1, 1, '住居費',    'home',      '#E1BFFF', 0, NOW(), NOW()),
  (3,  1, 1, '交通費',    'transport', '#62B2FD', 0, NOW(), NOW()),
  (4,  1, 1, '光熱費',    'utilities', '#9BDFC4', 0, NOW(), NOW()),
  (5,  1, 1, '娯楽',      'fun',       '#F99BAB', 0, NOW(), NOW()),
  (6,  1, 1, '洋服',      'clothes',   '#FFC6D7', 0, NOW(), NOW()),
  (7,  1, 1, '医療費',    'medical',   '#9F97F7', 0, NOW(), NOW()),
  (8,  1, 1, '日用品',    'daily',     '#AEE3F5', 0, NOW(), NOW()),
  (9,  1, 1, '支出その他','other_exp', '#86BE63', 0, NOW(), NOW()),

  -- 収入（1）
  (10, 1, 1, '給料',      'salary',    '#FACC15', 1, NOW(), NOW()),
  (11, 1, 1, '収入その他','other_inc', '#FFD5D2', 1, NOW(), NOW());
